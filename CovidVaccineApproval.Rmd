...
#sending on the abv and affiliation standing to  to be process in the next phase 
...
flu_number_usa.vaccine
  ...
  #scale_y_discrete(labels= reAjustedCases.Y)
```
...
#View(states_vaccinated_details)
...
#Now we need to combine data between political affiliation and COVID when it comes to states. States are now defined by their political standing based off of presidential election.
